...
#def PLAYER_BEGINX		584		// set the starting positon x of the player in map (when a new game begins)
#def PLAYER_BEGINY		382		// set the starting positon y of the player in map (when a new game begins)
